...
const pages: Page[] = [
  { path: "/", title: "スリランカのタクシーチャーター（カーチャーター）を選ぶ際のポイント(日本語対応/ライセンス/評価)とは？", description: "スリランカ旅行で相談できるタクシーチャーター会社4社を紹介。料金は距離・日数・車種等に応じた見積もりです。日本語対応、SLTDAライセンス、第三者口コミの確認ポイントを解説します。", keywords: "スリランカタクシーチャーター,スリランカカーチャーター,SLTDA,スリランカ観光タクシー,スリランカ旅行", image: "/manus-storage/charter-1_ee4f51c5.png" },
  ...
  { path: "/articles/sri-lanka-independent-travel-preparation-guide", title: "スリランカ個人旅行の準備完全ガイド｜出発前に必要なことを時系列で解説", description: "スリランカ個人旅行の準備を時系列で解説。ETA、パスポート、航空券、ホテル、通信、海外旅行保険、空港送迎、都市間移動まで、出発前に確認したいことを整理します。", keywords: "スリランカ 個人旅行 準備,スリランカ旅行 準備,スリランカ ETA,スリランカ 空港送迎", image: "/manus-storage/article-airport-transfer-hero_fd800259.jpg", article: true, faq: [{ question: "スリランカ個人旅行の準備はいつから始めればよいですか？", answer: "行き先・パスポート・ETAなど早めに確認したい項目があるため、出発の8〜12週間前を目安に旅程の軸を決めると進めやすくなります。パスポートの期限が近い場合は、さらに早く確認しましょう。" }, { question: "スリランカ入国にETAは必要ですか？", answer: "スリランカ政府のETA公式サイトは、原則として外国人旅行者に到着前の電子渡航認証を案内しています。対象国・目的・渡航時点の条件により異なるため、出発前にスリランカ入国管理局と公式ETAサイトを必ず確認してください。" }, { question: "ETAの承認画面は印刷した方がよいですか？", answer: "スマートフォンに保存するほか、紙やオフラインで見られるPDFにも残しておくと安心です。通信や電池に問題があっても、入国・ホテル・送迎に必要な情報を示しやすくなります。" }, { question: "空港送迎は出発前に予約した方がよいですか？", answer: "必須ではありませんが、初めての個人旅行、深夜・早朝到着、遠方のホテル、荷物が多い場合は、事前に合流場所と車を決めておくと到着日の判断を減らせます。" }, { question: "たびレジは登録した方がよいですか？", answer: "外務省のたびレジは、出発前から旅行中まで日本語の海外安全情報を受け取れる無料サービスです。緊急時に備えるため、渡航予定を登録しておくことを検討しましょう。" }, { question: "通信は現地SIM・eSIM・海外Wi-Fiのどれを選べばよいですか？", answer: "端末の対応状況、必要なデータ量、通話の必要性、到着後すぐ通信したいかで選びます。地図、ホテル連絡、配車アプリを使う予定なら、出発前に設定方法を確認し、ホテル住所や連絡先をオフラインにも保存しておきましょう。" }] },
...
pages.push(
  ...
  { path: "/articles/sigiriya-rock-access-highlights-mysteries-guide", title: "シーギリヤロックの行き方・見所・謎を完全解説｜登頂前に知りたい歴史と観光のコツ", description: "シーギリヤロックの行き方、見所、謎を徹底解説。登頂の順路、壁画・ライオンテラス・頂上、歴史の解釈、服装・持ち物、ダンブッラやキャンディと組み合わせる旅程を紹介します。", keywords: "シーギリヤロック 行き方,シーギリヤロック 見所,シーギリヤロック 謎,シーギリヤロック 観光,スリランカ 世界遺産", image: "/manus-storage/sigiriya-1_60f050bc.jpg", article: true, faq: [{ question: "シーギリヤロックはどこから行くのが便利ですか？", answer: "ダンブッラ、ハバラナ、シーギリヤ周辺に宿泊し、翌朝に向かう方法が旅程を組みやすいでしょう。空港、コロンボ、キャンディからは長距離になるため、到着日・ホテル移動日・休憩を含めて考えます。" }, { question: "シーギリヤロックの見所は頂上だけですか？", answer: "頂上だけではありません。麓の庭園、壁画、ミラーウォール、獅子門、岩山の上の遺構が、登る順に続く主な見所です。各場所で立ち止まる時間を残しましょう。" }, { question: "シーギリヤロックの謎とは何ですか？", answer: "王宮・要塞としての歴史は広く知られますが、壁画の人物像や遺構の詳細な用途などには複数の解釈が残ります。確定した事実と解釈を分けて見ることで、より深く楽しめます。" }, { question: "シーギリヤロックはどのくらい体力が必要ですか？", answer: "階段や高所を含むため、暑さ・雨・混雑・体調で負担が変わります。早めの時間に訪れ、水分と歩きやすい靴を用意し、現地の安全案内に従って無理をしないことが大切です。" }] },
  { path: "/articles/kandy-temple-of-the-tooth-guide", title: "キャンディ仏歯寺完全ガイド｜見どころ・参拝マナー・服装・行き方を解説", description: "キャンディ仏歯寺の見どころ、参拝マナー、服装、行き方、プージャの考え方を解説。仏歯を祀る神聖な寺院を、キャンディ湖・王宮エリアとあわせて訪れるための実用ガイドです。", keywords: "キャンディ仏歯寺,キャンディ 仏歯寺 見どころ,キャンディ 仏歯寺 服装,キャンディ 仏歯寺 行き方,スリランカ 寺院", image: "/manus-storage/kandy-1_5ad18432.jpg", article: true, faq: [{ question: "キャンディ仏歯寺はどんな場所ですか？", answer: "ブッダの歯の遺物を祀る重要な仏教寺院で、キャンディ王国の歴史とも深く結びついています。礼拝が行われる神聖な場所として、服装や振る舞いに配慮して訪れましょう。" }, { question: "キャンディ仏歯寺ではどんな服装が必要ですか？", answer: "肩と膝を覆える控えめな服装を用意し、入口での服装・履物・荷物に関する案内に従います。白い服を着る参拝者もいますが、旅行者に白が必須とは限りません。" }, { question: "プージャは見学できますか？", answer: "礼拝・儀式の時間や見学方法は変更され得ます。寺院公式サイトと訪問日の案内を確認し、早めに到着してスタッフの指示に従ってください。" }, { question: "キャンディ仏歯寺はどのくらい時間を取ればよいですか？", answer: "参拝、建築、周辺の王宮エリア、キャンディ湖畔まで含めるなら、移動直後に急ぐより余裕を持った時間を確保するのがおすすめです。儀式を希望する場合は、さらに待ち時間を見込みましょう。" }] },
);
