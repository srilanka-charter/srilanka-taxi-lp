    ...
    <div className="min-h-screen" style={{ backgroundColor: "#0A1520", color: "#F0F4F8" }}>
      ...
      <main>
        ...
        <article className="max-w-3xl mx-auto px-5 md:px-8 pb-20 md:pb-28">
          ...
          <p className="font-sans text-[15px] md:text-base leading-8 mt-5" style={{ color: "#C7D3DB" }}>トゥクトゥク・配車アプリ・専用車を旅程全体から比較したい方は、<Link href="/articles/sri-lanka-transport-guide" className="underline decoration-[#E8732A] underline-offset-4 hover:text-white">スリランカの移動手段は何が正解？</Link>を確認してください。</p>
