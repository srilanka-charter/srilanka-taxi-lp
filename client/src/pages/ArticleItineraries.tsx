...
const itineraries: Record<"five" | "seven" | "four", Itinerary> = {
  ...
  seven: {
    ...
    days: [
      ...
      { label: "DAY 2", stay: "シーギリヤ周辺泊", title: "シーギリヤロックとダンブッラを、暑さに合わせて巡る", body: "朝はシーギリヤロック、午後はダンブッラ石窟寺院へ。二つの訪問順は天候・混雑・体力で入れ替えて構いません。時間に追われないよう、ホテルで休憩する余白も残しましょう。", detail: ["シーギリヤロックは、登頂までの道のりだけでなく、麓から岩山を見上げる時間にも魅力があります。朝のうちに登るプランなら、ホテルに戻って涼しい時間に休憩を入れ、その後にダンブッラへ向かう流れが快適です。", "寺院の見学では、濡れた路面や裸足で歩く場面もあるため、歩きやすい靴と拭けるタオルを用意しておくと安心です。短い旅でも、この日は観光を増やしすぎず、文化三角地帯の中心をじっくり味わいましょう。"], images: [{ src: "/manus-storage/sigiriya-1_60f050bc.jpg", alt: "シーギリヤロックを見上げる旅行者", caption: "DAY 2：朝のシーギリヤロックは、世界遺産巡りの中心となる時間です。" }, { src: "/manus-storage/dambulla-ceiling_da604173.jpg", alt: "ダンブッラ石窟寺院の仏像と天井画", caption: "DAY 2：午後はダンブッラ石窟寺院で、洞窟の仏像と天井画を見学します。" }], note: "世界遺産を一日にまとめる日は、車に飲み物や着替えを置けると快適です。" },
      { label: "DAY 3", stay: "キャンディ泊", title: "キャンディへ移動し、仏歯寺の夜に触れる", body: "文化三角地帯からキャンディへ移動します。到着後はホテルで少し休み、夕方から仏歯寺周辺を訪れる流れが組みやすいでしょう。寺院の行事・入場・服装などは、当日の案内に従ってください。", detail: ["移動途中の立ち寄りは、スパイスガーデンや食事など、ひとつか二つに絞るのがポイントです。予定を入れすぎると、キャンディ到着が遅れ、ホテルで休む時間や寺院周辺を歩く時間が削られてしまいます。", "仏歯寺を訪れるなら、夕方以降の混雑や参拝の空気も含めて楽しみます。写真だけを急いで撮るのではなく、服装を整え、入場時の案内を確認しながら、キャンディらしい一夜を過ごしましょう。"], images: [{ src: "/manus-storage/kandy-1_5ad18432.jpg", alt: "キャンディ仏歯寺", caption: "DAY 3：キャンディでは、仏歯寺を訪れる時間をその日の中心に置きます。" }], note: "都市間移動の途中にスパイスガーデンや食事を入れる場合は、滞在時間を決めておくと安心です。" },
      { label: "DAY 4", stay: "ヌワラエリヤまたはエッラ泊", title: "高原へ向かい、紅茶列車を旅のハイライトにする", body: "キャンディから高原へ進み、旅程に合う区間で紅茶列車を楽しみます。列車の時刻・予約・運行状況は事前に確認し、駅まで・駅からの移動と荷物の扱いまで考えておくことが大切です。", detail: ["紅茶列車は、都市間を最短で移動するための乗り物ではなく、窓の外に広がる高原の景色を味わうための時間として組み込みます。どの区間に乗るか、席をどうするか、荷物をどう運ぶかまで決めておくと、当日は景色に集中しやすくなります。", "列車を降りた後の駅からホテルまでを、事前に手配した車でつなぐと、暗くなる時間や荷物の心配を小さくできます。列車の運行状況は変わり得るため、必ず公式案内と当日の情報を確認してください。"], images: [{ src: trainImage, alt: "スリランカ高原を走る紅茶列車", caption: "DAY 4：紅茶列車は、移動を急ぐためではなく高原の景色を味わう時間として組み込みます。" }], note: "列車は景色を味わう時間に。ホテル移動と観光を同時に詰め込みすぎないようにします。" },
